...
class TestMakeCmap:
    ...
    def test_make_cmap_default_type(self):
        colors = ["red", "green", "blue"]
        cmap = make_cmap(colors, name="mycustomcmap")

        assert isinstance(cmap, ListedColormap)
        assert cmap.name == "mycustomcmap"
        assert cmap.colors == colors

    def test_make_cmap_is_registered(self):
        colors = ["red", "green", "blue"]
        make_cmap(colors, name="mycustomcmap")
    ...
    def test_make_cmap_invalid_type(self):
        ...
        with pytest.raises(ValueError) as excinfo:
            make_cmap(colors, cmap_type="invalid", name="mycustomcmap")
    ...
    def test_make_cmap_single_color(self):
        cmap = make_cmap(["red"], name="mycustomcmap")
    ...
    def test_make_cmap_many_colors(self):
        ...
        cmap = make_cmap(colors, cmap_type="continuous", name="mycustomcmap")
